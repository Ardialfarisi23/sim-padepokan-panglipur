<div class="modal fade" id="modalRestock" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content custom-modal-content"> {{-- Sesuaikan class dengan CSS --}}
            ...
            <form action="{{ route('admin.seragam.updateStock') }}" method="POST">
                ...
                <div class="modal-body">
                    <p class="modal-subtitle">Pilih ukuran seragam dan masukkan jumlah stok yang masuk ke gudang.</p>
                    
                    <div class="form-group-custom">
                        <label class="input-label">Pilih Ukuran</label>
                        <div class="size-grid"> {{-- Gunakan size-grid sesuai CSS --}}
